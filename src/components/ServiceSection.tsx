...
const Services = () => {
  ...
  return (
    ...
    >
      {/* Heading Section */}
      <div className="pt-12 pb-8 sm:pt-16 sm:pb-10 md:pt-20 md:pb-12 px-5 sm:px-6 md:px-16 " style={{ fontFamily: 'Podium Soft Variable' }}>
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center text-[#2A2A2A] leading-tight tracking-tight font-bold" >
