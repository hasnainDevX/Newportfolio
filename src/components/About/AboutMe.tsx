      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative h-[520px] sm:h-[600px] lg:h-[700px]">
          <div
            ...
            style={{ opacity: 0 }}
          >
            <img src={image1} alt="Project" className="w-full h-auto object-cover block" />
          </div>
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <img src={image2} alt="Project" className="w-full h-auto object-cover block" />
          </div>
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <img src={image3} alt="Project" className="w-full max-h-[80%] object-cover block" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-7">
          ...
          <Link ref={ctaRef} to="/portfolio" style={{ opacity: 0 }}>
