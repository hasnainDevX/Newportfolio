    ...
    <div className="min-h-screen w-full px-6 md:px-16 lg:px-24 py-16 flex items-center">
      <div className="bg-soft-blue/30 w-full max-w-6xl mx-auto p-12 md:p-16 lg:p-20 rounded-3xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-charcoal" style={{ fontFamily: 'Impact, Haettenschweiler, "Franklin Gothic Bold", sans-serif' }}>
            Industries I've Worked With
          </h2>
          
          <p className="text-xl md:text-2xl lg:text-3xl font-light leading-relaxed text-[#2a2a2a] max-w-4xl" style={{ fontFamily: 'Georgia, serif' }}>
